...
type ArithmeticOperatorTree
    ...
    | ArithmeticValueLeaf VisualValue
...
fromArithmeticTypedValue : VisualValue -> ArithmeticOperatorTree
...
helperArithmeticTreeBuilderRecursion : VisualValue -> String -> List ArithmeticOperatorTree
